...
def fairprice_orderflow_sign(window:int, agressiveness:int)->Callable[[Trader],int]:
    """
...
def fairprice_orderflow_magnitude(window:int, agressiveness:int)->Callable[[Trader],int]:
    """
...
def fairprice_news_impact_exponential(window:int, agressiveness:int)->Callable[[Trader],int]:
    """
    Fairprice policy based on the news impact.
    """
    def func(trader:Trader)->int:
...
def volume_mm_max_fraction(fraction:float = 0.2) -> Callable[[Trader],Tuple[int,int]]:
    """
...
def spread_mm_orderflow_imbalance(window:int, agressiveness:int, min_halfspread:int, inventory_risk_factor:int = 5)->Callable[[Trader],Tuple[int,int]]:
    """
